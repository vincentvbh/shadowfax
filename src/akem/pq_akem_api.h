...
#define PQ_AKEM_SECRETKEY_BYTES sizeof(pq_akem_sk)
#define PQ_AKEM_PUBLICKEY_BYTES sizeof(pq_akem_pk)
#define PQ_AKEM_CIPHERTXT_BYTES sizeof(pq_akem_ct)
#define PQ_AKEM_CRYPTO_BYTES ((size_t)32)
